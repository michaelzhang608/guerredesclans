...
def add_points(change, password):
    if check_pass("/home/guerredesclans/mysite/password.txt", password):
        ...
        write_csv("/home/guerredesclans/mysite/log.csv", log)
        write_csv("/home/guerredesclans/mysite/db.csv", points)
        return change[0]
    else:
        return False
